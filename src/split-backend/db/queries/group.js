...
count(case when is_payment = false then by else null end) as number_of_transactions, 
count(case when is_payment = true then by else null end) as number_of_payments 
